...
const MainDashboard: NextPage = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Get dashboard data from our API
      const dashboardResponse = await getDashboardData();
      const statsResponse = await getDashboardStats();
      
      if (dashboardResponse.status === 'success' && statsResponse.status === 'success') {
        // Transform the API response to match our dashboard structure
        const transformedData: DashboardData = {
          dashboard_info: {
            title: "RiskAI Enhanced Platform",
            subtitle: "Enterprise-grade cybersecurity risk assessment with AI-powered insights",
            version: "2.0.0",
            description: "Comprehensive risk assessment with mathematical scoring, bias detection, and source attribution"
          },
          navigation_cards: [
            {
              id: "assessment",
              title: "Risk Assessment",
              description: "Complete 120-question cybersecurity assessment with real-time scoring",
              icon: "🛡️",
              category: "Assessment",
              route: "/assessment-simple",
              enabled: true,
              badge: "Enhanced",
              priority: "high",
              estimated_time: "45-60 minutes",
              features: [
                "120 comprehensive questions across 12 domains",
                "Real-time mathematical scoring",
            ...
            },
            {
              ...
              description: "View detailed reports with scoring breakdown and recommendations",
              icon: "📊",
              category: "Reporting",
              route: "/reports",
              enabled: true,
            ...
            },
            {
              id: "research_demo",
              title: "Research Demo",
              description: "Interactive demonstration of enhanced features for research purposes",
              icon: "🔬",
              category: "Research",
              route: "/research-demo",
              enabled: true,
            ...
            },
            {
              ...
              description: "Advanced mathematical scoring with confidence intervals",
              icon: "🧮",
              category: "Analytics",
              route: "/scoring",
              enabled: true,
          ...
          assessment_progress: {
            ...
            total_sections: 12,
            estimated_time_remaining: "45-60 minutes"
          },
          quick_actions: [
            {
              id: "start_assessment",
              title: "Start New Assessment",
              description: "Begin a comprehensive 120-question risk assessment",
              icon: "🚀",
              route: "/assessment-simple",
              primary: true,
              enabled: true
            },
            {
              id: "view_reports",
              title: "View Reports",
              description: "Access your assessment reports and analytics",
              icon: "📈",
              route: "/reports",
              primary: false,
              enabled: true
            },
            {
              id: "research_demo",
              title: "Research Demo",
              description: "Explore enhanced features and mathematical models",
              icon: "🔬",
              route: "/research-demo",
              primary: false,
              enabled: true
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {getCardsByCategory(selectedCategory).map((card) => (
              <div
                ...
                className={`bg-gray-800 backdrop-blur-md rounded-xl p-8 border-2 transition-all duration-300 cursor-pointer hover:bg-gray-700 hover:scale-105 hover:shadow-2xl ${getPriorityColor(card.priority)} ${
